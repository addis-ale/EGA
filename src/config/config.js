const config = {
  ...
  //   fabricAppId: process.env.NEXT_PUBLIC_FABRIC_APP_ID || "your-app-id",
  //   merchantAppId: process.env.NEXT_PUBLIC_MERCHANT_APP_ID || "your-merchant-id",
  ...
  appSecret: "dawitaddiseg",
  merchantAppId: "1380583211161603",
  merchantCode: "38527",
