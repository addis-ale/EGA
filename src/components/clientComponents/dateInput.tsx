...
export default function DateRangeDialog({ product }: DateRangeDialogProps) {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    toast({
      ...
      description: `From ${format(values.startDate, "PPP")} to ${format(
        values.endDate,
        "PPP"
      )}`,
    });
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        ...
        >
          ...
          <span className="text-white xs:hidden">Save to rent</span>
        </Button>
      </DialogTrigger>
      <DialogContent
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Choose a start and end date for your event or booking.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
