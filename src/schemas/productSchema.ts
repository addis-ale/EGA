...
export const productSchema = z.object({
  ...
  pricing: z
    ...
    .refine(
      (data) => {
        if (
          ...
          data.rentalPricePerHour === undefined
        ) {
          return false;
        }
        return true;
    ...
    .refine(
      (data) => {
        if (
          data.minimumRentalPeriod !== undefined &&
          data.maximumRentalPeriod !== undefined &&
          data.minimumRentalPeriod > data.maximumRentalPeriod
        ) {
          return false;
        }
        return true;
